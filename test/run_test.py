...
S390X_BLOCKLIST = [
    # following tests fail for various reasons
    "test_multiprocessing",
    "ao/sparsity/test_composability",
    "ao/sparsity/test_qlinear_packed_params",
    "cpp/aot_inductor/test",
    "cpp_api_parity/functional_impl_check",
    "cpp_api_parity/module_impl_check",
    "cpp_extensions/no_python_abi_suffix_test/setup",
    "cpp_extensions/setup",
    "custom_backend/test_custom_backend",
    ...
    "functorch/discover_coverage",
    "functorch/xfail_suggester",
    "fx/test_source_matcher_utils",
    "fx/test_z3_gradual_types",
    "inductor/minifier_smoke",
    ...
    "jit/fixtures_srcs/generate_models",
    ...
    "jit/test_list_dict",
    "jit/test_peephole",
    "jit/test_script_profile",
    "jit/test_tracer",
    "jit/test_type_sharing",
    "jit/test_types",
    "jit/test_with",
    "jit/xnnpack/test_xnnpack_delegate",
    "lazy/test_meta_kernel",
    "mobile/custom_build/prepare_model",
    "mobile/model_test/gen_test_model",
    "mobile/model_test/torchvision_models",
    "mobile/model_test/update_production_ops",
    "mobile/test_lite_script_module",
    "mobile/test_lite_script_type",
    "mobile/test_quantize_fx_lite_script_module",
    "onnx/*",
    "profiler/test_profiler",
    "quantization/core/experimental/apot_fx_graph_mode_ptq",
    "quantization/core/experimental/apot_fx_graph_mode_qat",
    "quantization/core/experimental/quantization_util",
    ...
    "quantization/core/test_docs",
    "quantization/core/test_workflow_module",
    "quantization/eager/test_fuse_eager",
    "quantization/eager/test_numeric_suite_eager",
    "quantization/eager/test_quantize_eager_ptq",
    "quantization/eager/test_quantize_eager_qat",
    "quantization/fx/test_quantize_fx",
    "quantization/jit/test_ondevice_quantization",
    "quantization/jit/test_quantize_jit",
    "quantization/pt2e/test_quantize_pt2e_qat",
    "scripts/run_cuda_memcheck",
    "test_ao_sparsity",
    "test_bundled_images",
    ...
    "typing/fail/bitwise_ops",
    "typing/fail/creation_ops",
    "typing/fail/disabled_bitwise_ops",
    "typing/fail/random",
    "typing/pass/creation_ops",
    "typing/pass/math_ops",
    "typing/reveal/module_list",
    "typing/reveal/namedtuple",
    "typing/reveal/opt_size",
    "typing/reveal/size",
    "typing/reveal/tensor_constructors",
    "typing/reveal/tensor_copy",
    "typing/reveal/tensor_sampling",
    "typing/reveal/torch_optim",
    # following tests are long, skip them for now
